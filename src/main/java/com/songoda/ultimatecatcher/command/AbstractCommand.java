...
public abstract class AbstractCommand {
    ...
    protected abstract ReturnType runCommand(UltimateCatcher instance, CommandSender sender, String... args);

    protected abstract List<String> onTab(UltimateCatcher instance, CommandSender sender, String... args);
