...
> **[Official UltimateCatcher website][Plugin page]**
>
...
UltimateCatcher is a Minecraft entity-capturing server plugin developed and maintained
by **Songoda Reborn**.

It lets players capture entities in throwable eggs, preserve their attributes, and
safely store or move them.
...
## Documentation
The [UltimateCatcher wiki][Plugin wiki] is maintained by Songoda Reborn and covers
installation, configuration, commands, permissions, dependencies, and compatibility.

## Support
For help with UltimateCatcher, join our [Discord server][Discord invite].

## Suggestions
Share feature suggestions and feedback through our [Discord server][Discord invite].


[Plugin page]: https://songoda-reborn.com/plugins/ultimatecatcher
[Plugin wiki]: https://songoda-reborn.com/plugins/ultimatecatcher/wiki
